...
class PaymentTables extends Component {
  constructor(props) {
    super(props);
    this.state = {
      smodal: false,
  ...
  componentDidMount() {
    Axios.get(`${X.ip}/api/finance/history`).then(res => {
                ...
                <div className="card-content">
                  ...
                  <InputGroup size="lg" className="no-border">
                    <Input
                      name="payment"
                      type="text"
                      defaultValue={this.state.dataOne.payment}
                    />
                  </InputGroup>
                  <Label>DOR</Label>
                  <InputGroup size="lg" className="no-border">
                    <Input
                      name="dateofreg"
                      type="date"
                      defaultValue={this.state.dataOne.date}
                    />
                  </InputGroup>
                </div>
