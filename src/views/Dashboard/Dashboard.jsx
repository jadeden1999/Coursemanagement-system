...
class Dashboard extends React.Component {
  ...
  componentDidMount() {
    ...
    Axios.get(`/api/instructor/getone/${obj.authid}`)
      .then(r => {
        this.setState({ inst: r.data });

        console.log(this.state.inst);
      })
      .catch(err => console.log("error", err));
    Axios.get(`/api/students/getnum`)
      .then(r => {
        this.setState({ num: r.data });
        console.log(this.state.inst);
      })
      .catch(err => console.log("error", err));
  }
