    ...
    return (
      <div>
        ...
        <div className="sidebar" data-color="blue">
          <div className="logo">
            <a href="https://DJLAB-LB.com" className="simple-text logo-mini">
              <div className="logo-img">
                <img src={logo} alt="react-logo" />
              </div>
            </a>
            <a href="https://DJLAB-LB.com" className="simple-text logo-normal">
              DJLAB SYS V0.2
            </a>
          ...
          <div className="sidebar-wrapper" ref="sidebar">
            ...
            <Nav>
              {this.props.routes.map((prop, key) => {
                console.log("level", prop.lvl);
                if (this.state.lvl < prop.lvl) {
                  return null;
                }
